...
public class BiomeStitcher extends CustomTool {
    ...
    public void onRightClick(PlayerInteractEvent event, Player player, ItemStack item) {
        ...
        Block reference = resolveReferenceBlock(event, player, sectionSize + 8, "biome_stitcher");
        ...
        plugin.getLangManager().send(player, "biome_stitcher.changed", 1000L,
                "biome", targetBiome.name(), "count", changed);
