...
import com.forgetools.diagnostics.ToolTelemetry;
...
public final class ForgeToolsPlugin extends JavaPlugin {
    ...
    private ToolTelemetry toolTelemetry;
    ...
    public void onEnable() {
        ...
        toolTelemetry = new ToolTelemetry(this);
    ...
    public void onDisable() {
        ...
        if (toolRegistry != null) toolRegistry.unload();
    ...
    public ToolTelemetry getToolTelemetry()              { return toolTelemetry; }
}
